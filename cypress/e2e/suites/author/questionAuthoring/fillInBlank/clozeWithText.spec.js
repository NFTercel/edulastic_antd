...
describe('Author - "Cloze with Text" type question', () => {
  ...
  context('Create basic question and validate.', () => {
    ...
    it('[clz_txt_s1] : user create question with default option and save', () => {   
      ...
      question.getTemplateEditor()
        .clear()
        .type(queData.template)
        .should('have.text',queData.template);
      
      question.TemplateMarkupBar.response()
        .click();
        
      question.getResponseBoxByIndex(0)
        .type(queData.correctAns);  
      // save que
    ...
    it('[clz_txt_s2] : preview and validate with right/wrong ans', () => {   
      ...
      .click().then(() => {
        question.getShowAnsBoxOnPreview()
