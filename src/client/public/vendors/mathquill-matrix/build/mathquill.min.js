...
!(function() {
  ...
  function c(e) {
    ...
    var s, r, o;
    if (!(z <= e && e <= R))
      throw "Only interface versions between " + z + " and " + R + " supported. You specified: " + e;
    (s = {}),
      (n.L = w),
      (n.R = x),
      (n.saneKeyboardEvents = M),
      (n.config = function(t) {
        return i(_.p, t), this;
      }),
      ...
      (s.EditableField = v(r, function(e, n) {
        (e.__mathquillify = function() {
          ...
          (e.dropEmbedded = function(t, e, n) {
            ...
            this.__controller.seek(q(o), t, e), (i = gt().setOptions(n)), i.createLeftOf(this.__controller.cursor);
          }),
      ...
      !(function(t, i) {
        ...
        (n[t] = function(i, s) {
          ...
          return a instanceof r || !i || !i.nodeType
            ? a
            : ((o = S(r.RootBlock(), q(i), _())), (o.KIND_OF_MQ = t), r(o).__mathquillify(s, e));
        }),
  ...
  function p(t, e) {
    (t.jQadd = function() {
      ...
      (t.reflow = function() {
        ...
        Z(this.delimjQs, Pt(1 + 0.2 * (t - 1), 1.2), 1.2 * t);
      });
  }
  function d(t, e) {
    var e = e || t,
  ...
  (g = [].slice),
    ...
    (O = v(function(t) {
      ...
      (this.byId = {}),
        (t.init = function() {
          (this.id = e()), (O.byId[this.id] = this), (this.ends = {}), (this.ends[w] = 0), (this.ends[x] = 0);
        }),
        (t.dispose = function() {
        ...
        (t.jQize = function(t) {
          ...
          var n;
          for (t = q(t || this.html()), n = 0; n < t.length; n += 1) e(t[n]);
          return t;
        }),
        (t.createDir = function(t, e) {
          r(t);
          var n = this;
          return n.jQize(), n.jQ.insDirOf(t, e.jQ), (e[t] = n.adopt(e.parent, e[w], e[x])), n;
        }),
      ...
      (t.init = function(t, e) {
        ...
        (t.show = function() {
          return (
            ...
            "intervalId" in this
              ...
              : (this[x]
                  ? this.selection && this.selection.ends[w][w] === this[w]
        ...
        (t.jumpUpDown = function(t, e) {
          ...
          (s.upDownCache[t.id] = y.copy(s)),
            ...
            n ? (n[x] ? s.insLeftOf(n[x]) : s.insAtRightEnd(n.parent)) : ((i = s.offset().left), e.seek(i, s));
        }),
        (t.offset = function() {
          var t = this,
        ...
        (t.unwrapGramp = function() {
          ...
          if (
            ...
            if (this[w]) this[x] = this[w][x];
              ...
              for (; !this[x]; ) {
                if (((this.parent = this.parent[x]), !this.parent)) {
          ...
          this[x] ? this.insLeftOf(this[x]) : this.insAtRightEnd(e),
            t.jQ.remove(),
            t[w].siblingDeleted && t[w].siblingDeleted(i.options, x),
        ...
        (t.select = function() {
          ...
          if ((s("cursor and anticursor in the same tree", e), (n = l.ancestors[e.id]), (o = x), t[w] !== n))
            for (a = t; a; a = a[x])
              if (a[x] === n[x]) {
                (o = w), (i = t), (r = n);
                break;
        ...
        (t.replaceSelection = function() {
          ...
          return t && ((this[w] = t.ends[w][w]), (this[x] = t.ends[x][x]), delete this.selection), t;
        });
    })),
    (C = v(k, function(t, e) {
      (t.init = function() {
    ...
    (S = v(function(t) {
      (t.init = function(t, e, n) {
        ...
        (t.handle = function(t, e) {
          ...
          i &&
            i.fns[t] &&
            ((n = i.APIClasses[this.KIND_OF_MQ](this)), e === w || e === x ? i.fns[t](e, n) : i.fns[t](n));
        });
      var e = [];
    ...
    (M = (function() {
      ...
      return function(n, i) {
        ...
        function o(e) {
          y(), (y = t), clearTimeout(g), x.val(e), e && x[0].select && x[0].select(), (b = !!e);
        }
        function a() {
          var t = x[0];
        ...
        function c(t) {
          (v = t),
            ...
            b &&
              r(function(t) {
                (t && "focusout" === t.type) || !x[0].select || x[0].select();
              }),
            l();
        }
        function h(t) {
        ...
        function f() {
          if (!a()) {
            var t = x.val();
            1 === t.length ? (x.val(""), i.typedText(t)) : t && x[0].select && x[0].select();
          }
        }
        function p() {
          v = w = null;
        ...
        var g,
          ...
          y = t;
        return (
          q.bind("keydown keypress input keyup focusout paste", function(t) {
            y(t);
          }),
          (b = !1),
          q.bind({
        ...
        (t.times = function(t, e) {
          ...
          return n(function(n, s, r) {
            ...
            var c,
              ...
              u = [],
              f = !0;
            for (h = 0; h < t; h += 1) if (!(f = i._(n, o, a))) return r(n, c);
    ...
    (F = (function() {
      ...
      function e(t) {
        var e,
          n = t[0] || V();
        for (e = 1; e < t.length; e += 1) t[e].children().adopt(n, n.ends[x], 0);
        return n;
      }
      var n = B.string,
        i = B.regex,
      ...
      (t.exportLatex = function() {
        ...
        (t.writeLatex = function(t) {
          ...
          return (
            r &&
              !r.isEmpty() &&
              (r.children().adopt(n.parent, n[w], n[x]),
              (e = r.jQize()),
              e.insertBefore(n.jQ),
              (n[w] = r.ends[x]),
              r.finalizeInsert(n.options, n),
              r.ends[x][x].siblingCreated && r.ends[x][x].siblingCreated(n.options, w),
              r.ends[w][w].siblingCreated && r.ends[w][w].siblingCreated(n.options, x),
        ...
        (t.renderLatexText = function(t) {
          ...
          if (
            ...
            for (h = 0; h < c.length; h += 1) c[h].adopt(u, u.ends[x], 0);
    ...
    S.open(function(t) {
      t.focusBlurEvents = function() {
        ...
        function e() {
          r.hide().parent.blur(), i.container.removeClass("mq-focused"), q(window).unbind("blur", t);
        }
        var n,
          i = this,
          s = i.root,
        ...
        return (
          n[x][i]
            ...
            : n.parent.bubble(function(t) {
                var e = t[s];
                if (e && ("function" == typeof e && (e = t[s](n)), e instanceof O && n.jumpUpDown(t, e), !0 !== e))
                  return !1;
              }),
          t
        );
      ...
      this.onNotify(function(t) {
        ...
        (t.deleteDir = function(t) {
          ...
          return (
            ...
            e[w].siblingDeleted && e[w].siblingDeleted(e.options, x),
            e[x].siblingDeleted && e[x].siblingDeleted(e.options, w),
        ...
        (t.ctrlDeleteDir = function(t) {
          r(t);
          var e = this.cursor;
          return !e[w] || e.selection
            ? this.deleteDir()
            : (this.notify("edit"),
              k(e.parent.ends[w], e[w]).remove(),
              e.insAtDirEnd(w, e.parent),
              e[w].siblingDeleted && e[w].siblingDeleted(e.options, x),
              e[x].siblingDeleted && e[x].siblingDeleted(e.options, w),
              e.parent.bubble("reflow"),
              this);
    ...
    S.open(function(t) {
      (_.p.substituteTextarea = function() {
        return q(
        ...
        (t.createTextarea = function() {
          var t,
            e = (this.textareaSpan = q('<span class="mq-textarea"></span>')),
        ...
        (t.staticMathTextareaEvents = function() {
          ...
          var e = this,
            ...
            i = e.textarea,
            s = e.textareaSpan;
          this.container.prepend(Mt('<span class="mq-selectable">').text("$" + e.exportLatex() + "$")),
            (e.blurred = !0),
            i
              .bind("cut paste", !1)
              .bind("copy", function() {
        ...
        (_.p.substituteKeyboardEvents = M),
      ...
      (_.p.ignoreNextMousedown = t),
        (e.delegateMouseEvents = function() {
          ...
          this.container.bind("mousedown.mathquill", function(n) {
            ...
            function r(t) {
              (h.blink = u),
                h.selection || (c.editable ? h.show() : f.detach()),
            ...
            n.preventDefault(),
              ...
              h.options.ignoreNextMousedown(n) ||
                ...
                (h.blink = t),
                c.seek(q(n.target), n.pageX, n.pageY).cursor.startSelection(),
                a.mousemove(i),
    ...
    S.open(function(t) {
      t.seek = function(t, e, n) {
        ...
        return (
          t && ((i = t.attr(Ft) || t.attr(Bt)) || ((r = t.parent()), (i = r.attr(Ft) || r.attr(Bt)))),
      ...
      (t.init = function(t, n, i) {
        ...
        (t.parser = function() {
          ...
          return t.times(e.numBlocks()).map(function(t) {
            e.blocks = t;
            for (var n = 0; n < t.length; n += 1) t[n].adopt(e, e.ends[x], 0);
            return e;
          });
        }),
        (t.createLeftOf = function(t) {
          ...
          n.createBlocks(),
            ...
            i && (i.adopt(n.ends[w], 0, 0), i.jQ.appendTo(n.ends[w].jQ)),
        ...
        (t.createBlocks = function() {
          var t,
            ...
            i = n.numBlocks(),
            s = (n.blocks = Array(i));
          for (t = 0; t < i; t += 1) (e = s[t] = V()), e.adopt(n, n.ends[x], 0);
        }),
        ...
        (t.seek = function(t, e) {
          function n(t) {
            var e = {};
            return (e[w] = t.jQ.offset().left), (e[x] = e[w] + t.jQ.outerWidth()), e;
          }
          var i,
            s = this,
            r = n(s);
          return t < r[w]
            ...
            : ((i = r[w]),
              void s.eachChild(function(o) {
                var a = n(o);
                return t < a[w]
                  ? (t - i < a[w] - t ? (o[w] ? e.insAtRightEnd(o[w]) : e.insLeftOf(s)) : e.insAtLeftEnd(o), !1)
                  : t > a[x]
                  ? void (o[x] ? (i = a[x]) : r[x] - t < t - a[x] ? e.insRightOf(s) : e.insAtRightEnd(o))
                  : (o.seek(t, e), !1);
              }));
        }),
    ...
    (V = v(P, function(t, e) {
      (t.join = function(t) {
        ...
        (t.text = function() {
          return this.ends[w] === this.ends[x] && 0 !== this.ends[w] ? this.ends[w].text() : this.join("text");
        }),
        (t.keystroke = function(t, n, i) {
          return !i.options.spaceBehavesLikeTab || ("Spacebar" !== t && "Shift-Spacebar" !== t)
            ...
            : (n.preventDefault(), void i.escapeDir("Shift-Spacebar" === t ? w : x, t, n));
        }),
      ...
      (t.ctrlSeq = "\\text"),
        ...
        (t.createLeftOf = function(t) {
          ...
          if (
            ...
            i[w].siblingCreated && i[w].siblingCreated(t.options, x),
            i.bubble("reflow"),
            t.insAtRightEnd(i),
            i.replacedText)
          )
            ...
            e.anticursor
              ? e.anticursor.parent === this &&
                ...
                this.anticursorPosition === c
                  ...
                  : (this.anticursorPosition < c
                      ? ((h = e[w].splitRight(this.anticursorPosition)), (e[w] = h))
                      : (h = e[x].splitRight(this.anticursorPosition - c)),
                    (e.anticursor = y(this, h[w], h))))
              : (this.anticursorPosition = e[w] && e[w].text.length);
        }),
        (t.blur = function(t) {
          V.prototype.blur.call(this),
            t &&
              ("" === this.textContents()
                ? (this.remove(), t[w] === this ? (t[w] = this[w]) : t[x] === this && (t[x] = this[x]))
                : n(this));
        }),
    ...
    (K = v(O, function(t, e) {
      ...
      (t.init = function(t) {
        ...
        (t.splitRight = function(t) {
          var e = K(this.text.slice(t)).adopt(this.parent, this, this[x]);
        ...
        (t.selectTowards = function(t, e) {
          ...
          return (
            ...
            (s = n(-t, this.text)),
            i[t] === this
              ? ((o = K(s).createDir(t, e)), (i[t] = o), e.insDirOf(t, o))
              : ((a = this[-t]),
                a ? a.insTextAtDirEnd(s, t) : ((o = K(s).createDir(-t, e)), o.jQ.insDirOf(-t, e.selection.jQ)),
    ...
    (j.em = j.italic = j.italics = j.emph = j.textit = j.textsl = u("\\textit", "i", 'class="mq-text-mode"')),
    (j.strong = j.bold = j.textbf = u("\\textbf", "b", 'class="mq-text-mode"')),
    (j.sf = j.textsf = u("\\textsf", "span", 'class="mq-sans-serif mq-text-mode"')),
    (j.tt = j.texttt = u("\\texttt", "span", 'class="mq-monospace mq-text-mode"')),
    (j.textsc = u("\\textsc", "span", 'style="font-variant:small-caps" class="mq-text-mode"')),
    (j.uppercase = u("\\uppercase", "span", 'style="text-transform:uppercase" class="mq-text-mode"')),
    (j.lowercase = u("\\lowercase", "span", 'style="text-transform:lowercase" class="mq-text-mode"')),
    (Y = v($, function(t, e) {
      (t.init = function(t) {
          ...
          e.createBlocks.call(this),
            ...
            (this.ends[w].write = function(t, e) {
              "$" !== e
                ...
                : this.isEmpty()
                ? (t.insRightOf(this.parent), this.parent.deleteTowards(dir, t), W("\\$", "$").createLeftOf(t.show()))
                : t[x]
                ? t[w]
                  ? V.prototype.write.call(this, t, e)
      ...
      (t.ctrlSeq = "\\"),
        ...
        (t.renderCommand = function(t) {
          ...
          (this.jQ = this.jQ.last()),
            this.remove(),
            this[x] ? t.insLeftOf(this[x]) : t.insAtRightEnd(this.parent),
            (e = this.ends[w].latex()),
            e || (e = " "),
            (n = j[e] || bt[e]),
            n
  ...
  it
    ...
    (j.underline = i(rt, "\\underline", "span", 'class="mq-non-leaf mq-underline"')),
    (j.overline = j.bar = i(rt, "\\overline", "span", 'class="mq-non-leaf mq-overline"')),
    (j.overrightarrow = i(rt, "\\overrightarrow", "span", 'class="mq-non-leaf mq-overarrow mq-arrow-right"')),
    (j.overleftarrow = i(rt, "\\overleftarrow", "span", 'class="mq-non-leaf mq-overarrow mq-arrow-left"')),
    (j.dot = v($, function(t, e) {
      t.init = function() {
        e.init.call(
          this,
          "\\dot",
    ...
    (ot = v($, function(t, e) {
      (t.ctrlSeq = "_{...}^{...}"),
        (t.createLeftOf = function(t) {
          if (this.replacedFragment || t[w] || !t.options.supSubsRequireOperand)
          ...
          for (e = w; e; e = e === w && x)
            if (this[e] instanceof ot) {
                    ...
                    (s
                      ? i.isEmpty()
                        ...
                        : (i.jQ.children().insAtDirEnd(-e, s.jQ),
                          (r = i.children().disown()),
                          (o = y(s, r.ends[x], s.ends[w])),
                          e === w ? r.adopt(s, s.ends[x], 0) : r.adopt(s, 0, s.ends[w]))
              ...
              this.remove(),
                t &&
                  t[w] === this &&
                  (e === x && o ? (o[w] ? t.insRightOf(o[w]) : t.insAtLeftEnd(o.parent)) : t.insRightOf(this[e]));
              break;
            }
        }),
        (_.p.charsThatBreakOutOfSupSub = ""),
        (t.finalizeTree = function() {
          this.ends[w].write = function(t, e) {
            if (t.options.autoSubscriptNumerals && this === this.parent.sub) {
              ...
              var n = this.chToCmd(e, t.options);
              return (
                n instanceof N ? t.deleteSelection() : t.clearSelection().insRightOf(this.parent),
        ...
        (t.deleteTowards = function(t, n) {
          if (n.options.autoSubscriptNumerals && this.sub) {
            ...
            i instanceof N ? i.remove() : i && i.deleteTowards(t, n.insAtDirEnd(-t, this.sub)),
              this.sub.isEmpty() &&
                (this.sub.deleteOutOf(w, n.insAtLeftEnd(this.sub)), this.sup && n.insDirOf(-t, this));
            ...
            !(function(t, e, n, i) {
              t[e].deleteOutOf = function(s, r) {
                ...
                (t.supsub = n),
                  ...
                  "sub" === e && q(t.jQ.addClass("mq-sup-only")[0].lastChild).remove(),
                  this.remove();
              };
    ...
    (j.superscript = j.supscript = j["^"] = v(ot, function(t, e) {
      (t.supsub = "sup"),
        ...
        (t.textTemplate = ["^"]),
        (t.finalizeTree = function() {
          (this.upInto = this.sup = this.ends[x]), (this.sup.downOutOf = f), e.finalizeTree.call(this);
        });
    })),
    (at = v($, function(t, e) {
      (t.init = function(t, e) {
        ...
        (t.createLeftOf = function(t) {
          e.createLeftOf.apply(this, arguments),
            t.options.sumStartsWithNEquals && (Ot("n").createLeftOf(t), zt().createLeftOf(t));
        }),
        (t.latex = function() {
          function t(t) {
            return 1 === t.length ? t : "{" + (t || " ") + "}";
          }
          return this.ctrlSeq + "_" + t(this.ends[w].latex()) + "^" + t(this.ends[x].latex());
        }),
        (t.parser = function() {
          var t,
            e = B.string,
            ...
            r = this,
            o = (r.blocks = [V(), V()]);
          for (t = 0; t < o.length; t += 1) o[t].adopt(r, r.ends[x], 0);
          return n
            .then(e("_").or(e("^")))
            .then(function(t) {
              var e = o["_" === t ? 0 : 1];
    ...
    (j["∫"] = j.int = j.integral = v(at, function(t, e) {
      (t.init = function() {
        N.prototype.init.call(
          this,
          "\\int ",
    ...
    (lt = j.frac = j.dfrac = j.cfrac = j.fraction = v($, function(t, e) {
      (t.ctrlSeq = "\\frac"),
        (t.htmlTemplate =
        ...
        (t.textTemplate = ["(", ")/(", ")"]),
        (t.finalizeTree = function() {
          (this.upInto = this.ends[x].upOutOf = this.ends[w]), (this.downInto = this.ends[w].downOutOf = this.ends[x]);
        });
    })),
    (ct = j.over = Q["/"] = v(lt, function(e, n) {
      e.createLeftOf = function(e) {
        if (!this.replacedFragment) {
          ...
          i instanceof at &&
            i[x] instanceof ot &&
            ((i = i[x]), i[x] instanceof ot && i[x].ctrlSeq != i.ctrlSeq && (i = i[x])),
            i !== e[w] && (this.replaces(k(i[x] || e.parent.ends[w], e[w])), (e[w] = i));
        }
        n.createLeftOf.call(this, e);
      };
    })),
    (ht = j.sqrt = j["√"] = v($, function(t, e) {
      (t.ctrlSeq = "\\sqrt"),
        (t.htmlTemplate =
        ...
        (t.reflow = function() {
          ...
          Z(t.prev(), 1, t.innerHeight() / +t.css("fontSize").slice(0, -2) - 0.1);
        });
    })),
    (j.hat = v($, function(t, e) {
      (t.ctrlSeq = "\\hat"),
        (t.htmlTemplate =
    ...
    (ut = j.nthroot = v(ht, function(t, e) {
      (t.htmlTemplate =
        ...
        (t.textTemplate = ["sqrt[", "](", ")"]),
        (t.latex = function() {
          return "\\sqrt[" + this.ends[w].latex() + "]{" + this.ends[x].latex() + "}";
        });
    })),
    (ft = v($, function(t, e) {
      t.init = function(t, n, i) {
    ...
    (pt = v(v($, p), function(e, n) {
      (e.init = function(t, e, i, s, r) {
        ...
        (e.latex = function() {
          return "\\left" + this.sides[w].ctrlSeq + this.ends[w].latex() + "\\right" + this.sides[x].ctrlSeq;
        }),
        (e.matchBrack = function(t, e, n) {
          return (
            ...
            (!t.restrictMismatchedBrackets ||
              dt[this.sides[this.side].ch] === n.sides[n.side].ch ||
              { "(": "]", "[": ")" }[this.sides[w].ch] === n.sides[x].ch) &&
            n
          );
        }),
        ...
        (e.createLeftOf = function(t) {
          ...
          this.replacedFragment ||
            ...
            (i =
              "|" === this.sides[w].ch
                ? this.matchBrack(e, x, t[x]) || this.matchBrack(e, w, t[w]) || this.matchBrack(e, 0, t.parent.parent)
            ...
            i
              ...
              : ((i = this),
                (s = i.side),
                i.replacedFragment ? (i.side = 0) : t[-s] && (i.replaces(k(t[-s], t.parent.ends[-s], s)), (t[-s] = 0)),
        ...
        (e.deleteSide = function(t, e, n) {
          ...
          if (
            ((i = n.options), (s = !this.side), (this.side = -t), this.matchBrack(i, t, this.ends[w].ends[this.side]))
          )
            ...
            a
              ? ((r = this.ends[w].ends[t]),
                k(a, l, -t)
                  ...
                  .jQ.insAtDirEnd(t, this.ends[w].jQ.removeClass("mq-empty")),
                r.siblingCreated && r.siblingCreated(n.options, t),
                n.insDirOf(-t, a))
              : e
              ? n.insDirOf(t, this)
    ...
    (j.right = v($, function(t) {
      t.parser = function() {
        return B.fail("unmatched \\right");
      };
    })),
    (mt = j.binom = j.binomial = v(v($, p), function(t, e) {
      (t.ctrlSeq = "\\binom"),
        (t.htmlTemplate =
    ...
    (j.editable = j.MathQuillMathField = v($, function(t, e) {
    ...
    (wt = bt.matrix = v(vt, function(t, e) {
      ...
      (t.parentheses = { left: null, right: null }),
        ...
        (t.reflow = function() {
          ...
          n.length && Z(n, Pt(1 + 0.2 * (e - 1), 1.2), 1.05 * e);
        }),
        (t.latex = function() {
          var t,
            e = "";
        ...
        (t.createBlocks = function() {
          this.blocks = [xt(0, this), xt(0, this), xt(1, this), xt(1, this)];
        }),
        (t.parser = function() {
          var t = this,
            e = B.optWhitespace,
          ...
          return e
            ...
            .then(function(e) {
              ...
              for (t.blocks = [], s = 0; s < e.length; s += 1)
                e[s] instanceof V ? r.push(e[s]) : (i(), e[s] === n.row && (o += 1));
        ...
        (t.relink = function() {
          var t,
            ...
            s = this.blocks,
            r = [];
          for (this.rowSize = s.length, i = 0; i < s.length; i += 1)
            (n = s[i]),
              t !== n.row && (1 === n.row && (this.rowSize = e), (t = n.row), (r[t] = []), (e = 0)),
              (r[t][e] = n),
              (n[x] = s[i + 1]),
              (n[w] = s[i - 1]),
        ...
        (t.autocorrect = function(t) {
          var e,
            ...
            o,
            a = [];
          for (t = [], e = this.blocks, o = 0; o < e.length; o += 1)
            (r = e[o].row), (t[r] = t[r] || []), t[r].push(e[o]), (a[r] = t[r].length);
          if ((n = Math.max.apply(null, a)) !== Math.min.apply(null, a)) {
            for (o = 0; o < t.length; o += 1)
              for (i = n - t[o].length; i; ) (s = n * o + t[o].length), e.splice(s, 0, xt(o, this)), (i -= 1);
            this.relink();
          }
        }),
        ...
        (t.addColumn = function(t) {
          ...
          for (
            ...
            (n = xt(i)),
              ...
              r.push(n),
              s[i].splice(e, 0, n),
              (n.jQ = q('<td class="mq-empty">').attr(Ft, n.id));
          return (
            this.jQ.find("tr").each(function(t) {
              q(this)
                .find("td")
                .eq(e - 1)
                .after(s[t][e].jQ);
            }),
            (this.blocks = [].concat.apply([], s)),
            r[t.row]
          );
        }),
    ...
    (bt.pmatrix = v(wt, function(t, e) {
      (t.environment = "pmatrix"), (t.parentheses = { left: "(", right: ")" });
    })),
    (bt.bmatrix = v(wt, function(t, e) {
      (t.environment = "bmatrix"), (t.parentheses = { left: "[", right: "]" });
    })),
    (bt.Bmatrix = v(wt, function(t, e) {
      (t.environment = "Bmatrix"), (t.parentheses = { left: "{", right: "}" });
    })),
    (bt.vmatrix = v(wt, function(t, e) {
      (t.environment = "vmatrix"), (t.parentheses = { left: "|", right: "|" });
    })),
    (bt.Vmatrix = v(wt, function(t, e) {
      (t.environment = "Vmatrix"), (t.parentheses = { left: "&#8214;", right: "&#8214;" });
    })),
    (xt = v(V, function(t, e) {
      (t.init = function(t, n, i) {
        if ((e.init.call(this), (this.row = t), n && this.adopt(n, n.ends[x], 0), i))
          for (var s = 0; s < i.length; s++) i[s].children().adopt(this, this.ends[x], 0);
      }),
        (t.keystroke = function(t, n, i) {
          switch (t) {
            case "Shift-Spacebar":
    ...
    (j["≠"] = j.ne = j.neq = i(U, "\\ne ", "&ne;")),
    (j["∗"] = j.ast = j.star = j.loast = j.lowast = i(U, "\\ast ", "&lowast;")),
    ...
    (j.ni = j.contains = i(U, "\\ni ", "&ni;")),
    (j.notni = j.niton = j.notcontains = j.doesnotcontain = i(U, "\\not\\ni ", "&#8716;")),
    (j.sub = j.subset = i(U, "\\subset ", "&sub;")),
    (j.sup = j.supset = j.superset = i(U, "\\supset ", "&sup;")),
    (j.nsub = j.notsub = j.nsubset = j.notsubset = i(U, "\\not\\subset ", "&#8836;")),
    (j.nsup = j.notsup = j.nsupset = j.notsupset = j.nsuperset = j.notsuperset = i(U, "\\not\\supset ", "&#8837;")),
    (j.sube = j.subeq = j.subsete = j.subseteq = i(U, "\\subseteq ", "&sube;")),
    (j.supe = j.supeq = j.supsete = j.supseteq = j.supersete = j.superseteq = i(U, "\\supseteq ", "&supe;")),
    (j.nsube = j.nsubeq = j.notsube = j.notsubeq = j.nsubsete = j.nsubseteq = j.notsubsete = j.notsubseteq = i(
      U,
      "\\not\\subseteq ",
      "&#8840;"
    )),
    (j.nsupe = j.nsupeq = j.notsupe = j.notsupeq = j.nsupsete = j.nsupseteq = j.notsupsete = j.notsupseteq = j.nsupersete = j.nsuperseteq = j.notsupersete = j.notsuperseteq = i(
      U,
      "\\not\\supseteq ",
      "&#8841;"
    )),
    (j.N = j.naturals = j.Naturals = i(W, "\\mathbb{N}", "&#8469;")),
    (j.P = j.primes = j.Primes = j.projective = j.Projective = j.probability = j.Probability = i(
      W,
      "\\mathbb{P}",
      "&#8473;"
    )),
    ...
    (j.C = j.complex = j.Complex = j.complexes = j.Complexes = j.complexplane = j.Complexplane = j.ComplexPlane = i(
      W,
      "\\mathbb{C}",
      "&#8450;"
    )),
    (j.H = j.Hamiltonian = j.quaternions = j.Quaternions = i(W, "\\mathbb{H}", "&#8461;")),
    ...
    (j.not = j["¬"] = j.neg = i(W, "\\neg ", "&not;")),
    (j["…"] = j.dots = j.ellip = j.hellip = j.ellipsis = j.hellipsis = i(W, "\\dots ", "&hellip;")),
    (j.converges = j.darr = j.dnarr = j.dnarrow = j.downarrow = i(W, "\\downarrow ", "&darr;")),
    (j.dArr = j.dnArr = j.dnArrow = j.Downarrow = i(W, "\\Downarrow ", "&dArr;")),
    ...
    (j.lArr = j.Leftarrow = i(W, "\\Leftarrow ", "&lArr;"));
  (j.harr = j.lrarr = j.leftrightarrow = i(W, "\\leftrightarrow ", "&harr;")),
    (j.iff = i(U, "\\Leftrightarrow ", "&hArr;")),
    (j.hArr = j.lrArr = j.Leftrightarrow = i(W, "\\Leftrightarrow ", "&hArr;")),
    (j.Re = j.Real = j.real = i(W, "\\Re ", "&real;")),
    (j.Im = j.imag = j.image = j.imagin = j.imaginary = j.Imaginary = i(W, "\\Im ", "&image;")),
    (j.part = j.partial = i(W, "\\partial ", "&part;")),
    (j.infty = j.infin = j.infinity = i(W, "\\infty ", "&infin;")),
    (j.alef = j.alefsym = j.aleph = j.alephsym = i(W, "\\aleph ", "&alefsym;")),
    ...
    (j.o = j.O = j.empty = j.emptyset = j.oslash = j.Oslash = j.nothing = j.varnothing = i(
      U,
      "\\varnothing ",
      "&empty;"
    )),
    ...
    (qt = v(W, function(t, e) {
      t.createLeftOf = function(t) {
        ...
        ((t[w] instanceof yt && !1 !== t[w].isItalic) ||
          (t[w] instanceof ot && t[w][w] instanceof yt && !1 !== t[w][w].isItalic))
          ? (j._().createLeftOf(t), e.createLeftOf.call(this, t), t.insRightOf(t.parent.parent))
          : e.createLeftOf.call(this, t);
      };
    })),
    (yt = v(N, function(t, e) {
          ...
          return (
            this.isPartOfOperator
              ...
              : (!this[w] ||
                  ...
                  "\\ " === this[w].ctrlSeq ||
                  (t = "*" + t),
                !this[x] || this[x] instanceof U || this[x] instanceof ot || (t += "*")),
            t
          );
        });
    })),
    (_.p.autoCommands = { _maxLength: 0 }),
      ...
      (t.init = function(t) {
        ...
        (t.createLeftOf = function(t) {
          ...
          if ((e.createLeftOf.apply(this, arguments), (n = t.options.autoCommands), (i = n._maxLength), i > 0)) {
            for (s = "", r = this, o = 0; r instanceof Ot && r.ctrlSeq === r.letter && o < i; )
        ...
        (t.finalizeTree = t.siblingDeleted = t.siblingCreated = function(t, e) {
          (e !== w && this[x] instanceof Ot) || this.autoUnItalicize(t);
        }),
        (t.autoUnItalicize = function(t) {
          ...
          if (0 !== d._maxLength) {
            ...
            for (s = this[x]; s instanceof Ot; s = s[x]) e += s.letter;
            k(i[x] || this.parent.ends[w], s[w] || this.parent.ends[x]).each(function(t) {
              t.italicize(!0).jQ.removeClass("mq-first mq-last mq-followed-by-supsub"), (t.ctrlSeq = t.letter);
            });
            t: for (r = 0, o = i[x] || this.parent.ends[w]; r < e.length; r += 1, o = o[x])
              for (a = Pt(d._maxLength, e.length - r); a > 0; a -= 1)
                if (((l = e.slice(r, r + a)), d.hasOwnProperty(l))) {
                  for (c = 0, h = o; c < a; c += 1, h = h[x]) h.italicize(!1), (u = h);
                  (f = kt.hasOwnProperty(l)),
                    (o.ctrlSeq = (f ? "\\" : "\\operatorname{") + o.ctrlSeq),
                    (u.ctrlSeq += f ? " " : "}"),
                    Qt.hasOwnProperty(l) && u[w][w][w].jQ.addClass("mq-last"),
                    n(o[w]) || o.jQ.addClass("mq-first"),
                    n(u[x]) ||
                      (u[x] instanceof ot
                        ? ((p = u[x]),
                          (p.siblingCreated = p.siblingDeleted = function() {
                            p.jQ.toggleClass("mq-after-operator-name", !(p[x] instanceof pt));
                          })())
                        : u.jQ.toggleClass("mq-last", !(u[x] instanceof pt))),
                    (r += a - 1),
                    (o = u);
                  continue t;
                }
    ...
    (kt = {}),
    (jt = _.p.autoOperatorNames = { _maxLength: 9 }),
    ...
    (function() {
      ...
      for (n = "sin cos tan sec cosec csc cotan cot ctg".split(" "), t = 0; t < n.length; t += 1)
        jt[n[t]] = jt["arc" + n[t]] = jt[n[t] + "h"] = jt["ar" + n[t] + "h"] = jt["arc" + n[t] + "h"] = 1;
      ...
      (t.init = function(t) {
        ...
        (t.parser = function() {
          var t,
            e = this.ctrlSeq,
            n = V();
          for (t = 0; t < e.length; t += 1) Ot(e.charAt(t)).adopt(n, n.ends[x], 0);
          return B.succeed(n.children());
        });
    }));
  for (Ct in jt) jt.hasOwnProperty(Ct) && (j[Ct] = Tt);
  (j.operatorname = v($, function(e) {
    (e.createLeftOf = t),
      (e.numBlocks = function() {
        return 1;
      }),
    ...
    (j["&"] = i(St, "\\&", "&amp;")),
    (j["%"] = i(St, "\\%", "%")),
    (j.alpha = j.beta = j.gamma = j.delta = j.zeta = j.eta = j.theta = j.iota = j.kappa = j.mu = j.nu = j.xi = j.rho = j.sigma = j.tau = j.chi = j.psi = j.omega = v(
      yt,
      function(t, e) {
        t.init = function(t) {
          e.init.call(this, "\\" + t + " ", "&" + t + ";");
    ...
    (j.thetav = j.vartheta = j.thetasym = i(yt, "\\vartheta ", "&thetasym;")),
    ...
    (j.pi = j["π"] = i(St, "\\pi ", "&pi;")),
    (j.lambda = i(St, "\\lambda ", "&lambda;")),
    (j.Upsilon = j.Upsi = j.upsih = j.Upsih = i(N, "\\Upsilon ", '<var style="font-family: serif">&upsih;</var>')),
    (j.Gamma = j.Delta = j.Theta = j.Lambda = j.Xi = j.Pi = j.Sigma = j.Phi = j.Psi = j.Omega = j.forall = v(
      W,
      function(t, e) {
        t.init = function(t) {
          e.init.call(this, "\\" + t + " ", "&" + t + ";");
      ...
      (t.init = function(t) {
        ...
        (t.createLeftOf = function(t) {
          ...
          e.children().adopt(t.parent, t[w], t[x]),
            ...
            e.ends[x][x].siblingCreated && e.ends[x][x].siblingCreated(t.options, w),
            e.ends[w][w].siblingCreated && e.ends[w][w].siblingCreated(t.options, x),
    ...
    (_t = v(U, function(t) {
      (t.init = W.prototype.init),
        (t.contactWeld = t.siblingCreated = t.siblingDeleted = function(t, e) {
          function n(t) {
            return t[w]
              ? t[w] instanceof U || /^[,;:\(\[]$/.test(t[w].ctrlSeq)
                ? ""
                : "mq-binary-operator"
          ...
          if (e !== x) return (this.jQ[0].className = n(this)), this;
        });
    })),
    (j["+"] = i(_t, "+", "+")),
    (j["–"] = j["-"] = i(_t, "-", "&minus;")),
    (j["±"] = j.pm = j.plusmn = j.plusminus = i(_t, "\\pm ", "&plusmn;")),
    (j.mp = j.mnplus = j.minusplus = i(_t, "\\mp ", "&#8723;")),
    ...
    (j["<"] = j.lt = i(Et, Lt, !0)),
    (j[">"] = j.gt = i(Et, At, !0)),
    (j["≤"] = j.le = j.leq = i(Et, Lt, !1)),
    (j["≥"] = j.ge = j.geq = i(Et, At, !1)),
    (zt = v(U, function(t, e) {
      (t.init = function() {
        e.init.call(this, "=", "=");
      }),
    ...
    (j["÷"] = j.div = j.divide = j.divides = i(U, "\\div ", "&divide;", "[/]")),
    (Q["~"] = j.sim = i(U, "\\sim ", "~", "~")),
    (Rt = c(1));
  for (It in Rt)
    !(function(t, e) {
